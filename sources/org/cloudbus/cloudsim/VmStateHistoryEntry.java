...
public class VmStateHistoryEntry {
	 ...
	 */
	public VmStateHistoryEntry(double time, double allocatedMips, double requestedMips, double allocatedRam, int requestedRam, boolean isInMigration) {
		setTime(time);
	 ...
	 * @param allocatedMips the new allocated mips
	 */
	protected void setAllocatedRam(double allocatedRam) {
...
/** _______________________________________ */
	 ...
	 * @param requestedMips the new requested mips
	 */
	protected void setRequestedRam(double requestedRam) {
