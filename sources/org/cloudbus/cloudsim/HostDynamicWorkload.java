...
public class HostDynamicWorkload extends Host {
	...
	private double previousUtilizationRam;
	...
	public double updateVmsProcessing(double currentTime) {
		...
		for (Vm vm : getVmList()) {
			...
			getVmScheduler().deallocateRamForVm(vm);
		}

		for (Vm vm : getVmList()) {
			getVmScheduler().allocatePesForVm(vm, vm.getCurrentRequestedMips());
			getVmScheduler().allocateRamForVm(vm, vm.getCurrentAllocatedRam());
		}
	 ...
	 * @param utilizationMips the new utilization mips
	 */
	protected void setUtilizationRam(double utilizationRam) {
	 ...
	 * @param previousUtilizationMips the new previous utilization mips
	 */
	protected void setPreviousUtilizationRam(double previousUtilizationRam) {
	...
	public
			void
			addStateHistoryEntry(double time, double allocatedMips, double requestedMips,double allocatedRam, int requestedRam, boolean isActive) {
