...
public class Vm {
	 ...
	 */
	/*
	 * public int getCurrentRequestedTotalRam() {
	 * 
	 * int currentRequestedRam; currentRequestedRam =
	 * (int)(getCloudletScheduler().getCurrentRequestedUtilizationOfRam() *
	 * getRam()); totalRequestedRam += getCurrentRequestedRam(); return
	 * totalRequestedRam; }
	 */
	 ...
	 * @param totalAllocatedRam 
	 * @param totalRequestedRam 
