 ...
 */
public class PowerVmAllocationPolicyMigrationOneOutOfThreeFactors extends PowerVmAllocationPolicyMigrationAbstract {
	 ...
	 */
	public PowerVmAllocationPolicyMigrationOneOutOfThreeFactors(
	...
	protected boolean isHostOverUtilized(PowerHost host) {
		...
		int length = 15; // we use 10 to make the regression responsive enough to latest values
