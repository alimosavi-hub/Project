 ...
 * @since Jan 5, 2012
 */
public class LrThreeFactorsMmt {
	...
	public static void main(String[] args) throws IOException {
		...
		String vmAllocationPolicy = "LrThreeFactorsMmt"; // Local Regression (LR) VM allocation policy
		String vmSelectionPolicy = "mmt"; // Minimum Migration Time (MMT) VM selection policy
		String parameter = "0.1"; // the safety parameter of the LR policy
